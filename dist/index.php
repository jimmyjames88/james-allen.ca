...
<html>
	<head>
		...
		<script type="text/javascript">
			var _gaq = _gaq || [];
			_gaq.push(['_setAccount', 'UA-33332952-1']);
	...
	<body>
		<div id="header" class="clr">
			...
			<div id="headerRight" class="hide-mobile">
		...
		<div id="main">
			...
			<div id="footer">
				<div class="content">
					<div class="footerQ">
						<img src="images/icon-phone.png" alt="Phone Number" />
						<div>(403)702-2795</div>
					</div>
					<div class="footerQ">
						<a href="mailto:me@james-allen.ca" title="Email Me"><img src="images/icon-email.png" alt="Email Me" /></a>
						<div>
							<a href="mailto:me@james-allen.ca" title="Email Me">me@james-allen.ca</a>
						</div>

					</div>
					<div class="footerQ">
						<img src="images/icon-skype.png" alt="Call or message me on Skype" />
						<div>
							<a href="skype:James.Allen.Calgary?call">James.Allen.Calgary</a>
						</div>
					</div>
					<div id="copyright" class="footerQ">
						<div>&copy; 2012 James Allen</div>
					</div>
				</div>
			</div>
		</div>
